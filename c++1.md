...
> [!WARNING]  
> 
> Estos límites no son universales. Su valor puede cambiar dependiendo del sistema y del compilador. Si ejecutas este código en otro entorno, podrías obtener resultados distintos. Si no estás seguro del valor en tu máquina, puedes consultarlo en cualquier momento con &lt;limits.h&gt;.  

<details><summary>💡 Hint: Usa &lt;limits.h&gt; para consultar los valores cuando los necesites</summary>

Los límites de las variables en C++ pueden consultarse con las constantes de <limits.h>. A continuación, un ejemplo con algunos de ellos.  
