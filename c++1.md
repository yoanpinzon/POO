...
- [2. **Estructura del Programa**](#2-estructura-del-programa)
  ...
  - [**Función `main`**](#función-main-1)
    - [**📌 Código en C++:**](#-código-en-c)
    - [**🖥️ Uso y salida en consola con diferentes argumentos:**](#️-uso-y-salida-en-consola-con-diferentes-argumentos)
    - [**⚡ `return 0` y `ERRORLEVEL` en el sistema operativo**](#-return-0-y-errorlevel-en-el-sistema-operativo)
...
### **🖥️ Uso y salida en consola con diferentes argumentos:**
...
### **⚡ `return 0` y `ERRORLEVEL` en el sistema operativo**  
