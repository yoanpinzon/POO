...
- [**👽 Tarea - Estacionamiento Intergaláctico** 🚀](#-tarea---estacionamiento-intergaláctico-)
  - [**�🚨 FECHA LÍMITE: 10 de FEBRERO - 10:00 AM 🚨📢**](#-fecha-límite-10-de-febrero---1000-am-)
  - [**📖 Historia**](#-historia)
  - [**📜 Reglas del Estacionamiento Espacial**](#-reglas-del-estacionamiento-espacial)
    - [**🚦 Tarifas Base (Lunes a Viernes - Días 1 a 5)**](#-tarifas-base-lunes-a-viernes---días-1-a-5)
    - [**🌌 Tarifas Especiales (Fines de Semana en Marte - Días 6 y 7)**](#-tarifas-especiales-fines-de-semana-en-marte---días-6-y-7)
    - [**🛸 Factores Cósmicos (Eventos Aleatorios del Universo)**](#-factores-cósmicos-eventos-aleatorios-del-universo)
    - [**⛔ Restricciones del Consejo Galáctico**](#-restricciones-del-consejo-galáctico)
  - [**📌 Entrada**](#-entrada)
  - [**📌 Salida**](#-salida)
  - [**📊 Ejemplo de Entrada y Salida**](#-ejemplo-de-entrada-y-salida)
    - [**Ejemplo 1** (Día de semana sin descuentos)](#ejemplo-1-día-de-semana-sin-descuentos)
      - [Entrada:](#entrada)
      - [Salida:](#salida)
    - [**Ejemplo 2** (Fin de semana con incremento)](#ejemplo-2-fin-de-semana-con-incremento)
      - [Entrada:](#entrada-1)
      - [Salida:](#salida-1)
    - [**Ejemplo 3** (Descuento por suma de dígitos)](#ejemplo-3-descuento-por-suma-de-dígitos)
      - [Entrada:](#entrada-2)
      - [Salida:](#salida-2)
    - [**Ejemplo 4** (Error por límite excedido)](#ejemplo-4-error-por-límite-excedido)
      - [Entrada:](#entrada-3)
      - [Salida:](#salida-3)
  - [**📜 Notas del Consejo Galáctico** 🛸](#-notas-del-consejo-galáctico-)
  - [**📌 ¿Cómo someter la tarea en GitHub Classroom?**](#-cómo-someter-la-tarea-en-github-classroom)
    - [**📝 Pasos para entregar tu código correctamente:**](#-pasos-para-entregar-tu-código-correctamente)
    - [**💻 Esqueleto del Código en C++ (Incompleto para que los estudiantes lo completen)**](#-esqueleto-del-código-en-c-incompleto-para-que-los-estudiantes-lo-completen)
